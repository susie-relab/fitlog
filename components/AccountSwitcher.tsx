...
export default function AccountSwitcher({ direction = 'down' }: { direction?: 'up' | 'down' }) {
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className={`absolute left-0 w-full min-w-[220px] rounded-lg border border-[#334155] bg-[#1E293B] shadow-xl z-50 py-1.5 ${direction === 'up' ? 'bottom-full mb-1' : 'top-full mt-1'}`}>
            {others.length > 0 && (
              <>
